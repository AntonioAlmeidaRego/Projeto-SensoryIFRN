...
export default class CadastroScreen extends Component<Props> {
    ...
    async componentDidMount(){
        const participantes = JSON.parse(await AsyncStorage.getItem("@CadastroSensory:sensoryIFRN")) || [];
        this.setState({
        ...
        email != '' && alergiaAlimento != '' && resultSexo != '' && idade != ''){
            if(this.verificarSenha(senha, confirmaSenha)){
                if(this.emailExist(email)){
                    ...
                    await AsyncStorage.setItem("@CadastroSensory:sensoryIFRN", JSON.stringify(this.state.participantes));
